...
/// Generator that creates BindX extensions for annotated classes
class BindxGenerator extends GeneratorForAnnotation<Cache> {
  @override
  Future<String> generateForAnnotatedElement(
    ...
    if (element is! ClassElement) {
      throw InvalidGenerationSourceError(
        '@Cache can only be applied to classes',
        element: element,
      );
    }

    return _generateStoreClass(element, annotation);
  }

  String _generateStoreClass(ClassElement element, ConstantReader annotation) {
